...
- (void)testCoordinateFactor {
	ARCoordinate *coordinate1 = [ARCoordinate coordinateWithRadialDistance:10.0 inclination:10.0 azimuth:10.0];
	STAssertNotNil(coordinate1, @"Coordinate factor method failed to create an instance.");
	
	ARCoordinate *coordinate2 = [ARCoordinate coordinateWithRadialDistance:10.0 inclination:10.0 azimuth:10.0];
